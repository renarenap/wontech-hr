...
const PAPER_NOTE = '제1저자 100%, 공동저자 50% 인정'
    ...
    <div>
      ...
      <div id="sec-6" style={{ ...crd, scrollMarginTop: 16 }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {[
              ...
              ['기술 성과', '해외 특허 등록', '2P', '4P(합산)', PATENT_NOTE],
              ['기술 성과', '국제논문 게재', '2P', '4P(합산)', PAPER_NOTE],
              ['기술 성과', '국내 특허 등록 · 국내 논문 게재', '1.5P', '4P(합산)', PATENT_NOTE],
              ['기술 성과', '실용신안 등록', '1P', '4P(합산)', PATENT_NOTE],
              ['기술 성과', '디자인 등록', '0.5P', '4P(합산)', PATENT_NOTE],
        ...
        <div style={{ fontSize: 11, color: '#94a3b8', marginTop: 12, lineHeight: 1.6 }}>
          ...
          * 유효기간 있는 자격은 포인트 인정을 위해 승진 후 재입증 필요<br />
          * 기술성과 항목은 승진 차수당 합산 최대 4P까지 인정하며, 승진 완료 시 리셋 — 이미 인정된 항목은 다음 승진 차수에 재인정 불가<br />
          * 기술성과 항목에서 인정된 특허·실용신안·디자인·국제논문 관련 성과에 대한 포상금은 포상(사내 포상) 항목에서 중복 인정 불가
        </div>
      </div>
