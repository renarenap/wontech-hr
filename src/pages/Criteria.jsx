...
const TECH_NOTE = '특허·실용신안·디자인은 제1발명자 100%·공동발명자 50%, 논문은 제1저자 100%·공동저자 50% 인정 (5개 항목 합산 최대 4P)'
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            {[
              ...
              ['기술 성과', '해외특허 2P · 국제논문 2P · 국내특허·국내논문 1.5P · 실용신안 1P · 디자인 0.5P', '—', '4P', TECH_NOTE],
